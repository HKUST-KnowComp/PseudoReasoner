...
CUDA_VISIBLE_DEVICES=0 python models/pseudo_labeling/train_kgbert_baseline.py \
    ...
    --relation_as_special_token \
    --save_best_model \
    --seed 102 --batch_size 64 --test_batch_size 128 --eval_every 250 --save_best_model --experiment_name "" --steps 5000
...
CUDA_VISIBLE_DEVICES=0 python models/pseudo_labeling/train_kgbert_baseline.py \
    ...
    --relation_as_special_token \
    --save_best_model \
    --seed 100 --batch_size 64 --test_batch_size 128 --eval_every 125 --save_best_model --experiment_name ""
